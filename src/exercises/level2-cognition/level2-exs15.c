/*
Note: Again, I've included all rat-related functions from exercise 8 & 14, even if they are not strictly necessary for this exercise.
*/
#include <stdio.h>
#include <stdlib.h>
#include <stdbool.h>
...
int main() {
    ...
    if (rat_print_normalized(buffsize, buffer, &r)) {
        printf("%s\n", buffer);
    }
}
